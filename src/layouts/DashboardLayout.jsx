...
const DashboardLayout = () => {
  ...
  return (
    ...
    <div className='max-w-[1600px] mx-auto'>
      ...
      <div className="grid grid-cols-12 min-h-screen  max-w-11/12 mx-auto">
  ...
  `}
        ...
        whitespace-nowrap bg-gray-800 text-white text-sm px-3 py-1 rounded-lg 
      ...
      "
        ...
        {/* Main content */}
        <div className={`col-span-12 ${mainColSpan} flex flex-col min-h-screen w-full transition-all duration-300`}>
