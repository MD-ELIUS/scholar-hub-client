...
const Banner = () => {
  ...
  return (
    <section className="max-w-11/12 mx-auto text-primary flex flex-col md:flex-row items-center justify-between gap-4 rounded-b-3xl mt-5 lg:mt-0 lg:max-h-[500px]">

      {/* Text Section */}
      <div className="lg:w-1/2 space-y-6 text-center md:text-left flex flex-col justify-center">
