...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#F4FAF9] border-t border-secondary/70 text-gray-700 mt-14">
      <div className="w-11/12 mx-auto py-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        <div className="grid grid-col-1 lg:grid-cols-2 gap-10 ">
          ...
          {/* Quick Links */}
          <div className="flex flex-col items-center text-center  lg:ml-14">
            <h3 className="text-xl font-semibold mb-2 md:mb-4 text-primary">Quick Links</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className={`transition-colors hover:text-secondary ${isHomeActive ? "text-secondary font-semibold" : ""
                    }`}
                >
                  Home
                </Link>
              ...
              <li>
                <Link
                  to="/all-scholarships"
                  className={`transition-colors hover:text-secondary ${isAllScholarshipsActive ? "text-secondary font-semibold" : ""
                    }`}
                >
                  All Scholarships
                </Link>
